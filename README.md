...
*GoldStandards*
This folder contains the XML files containing the text corpus. The text in this corpus was collected from Twitter, and was annotated using [MAE](http://keighrim.github.io/mae-annotation/). Each file contains a set of tweets, along with XML tags representing annotations.
*CONTENT WARNING:*
